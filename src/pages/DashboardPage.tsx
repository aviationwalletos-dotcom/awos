...
export function DashboardPage() {
  ...
  return (
    <div data-mbaas-oid="1s3qk1u" className="min-h-screen bg-white font-body">
      ...
      <main data-mbaas-oid="um7limy">
        <section data-mbaas-oid="74h26xy" className="relative overflow-hidden bg-navy-dark py-[clamp(24px,3vw,40px)] text-white">
          <div data-mbaas-oid="9diwe1c" className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_85%_10%,rgba(56,189,248,0.14),transparent_50%)]" />
        ...
        <section data-mbaas-oid="m7owuca" className="sticky top-[121px] z-30 border-b border-slate-200 bg-white/95 backdrop-blur">
 ...
 data-mbaas-oid="nwhuhzi" key={key}
        ...
        {activeTab === 'goNoGo' && (
          <section data-mbaas-oid="msovsec" className="bg-white py-[clamp(64px,8vw,120px)]">
            <div data-mbaas-oid="msovsc2" className="mx-auto max-w-7xl px-6">
              <Reveal>
                ...
                <p data-mbaas-oid="msovsc4" className="mt-2 text-sm text-slate-500">
        ...
        {activeTab === 'personnel' && (
          <>
            {(!myAffiliation || isLoading || error) && (
              <section data-mbaas-oid="hl7g24g" className="bg-white py-6">
                <div data-mbaas-oid="cdqcsv3" className="mx-auto max-w-7xl px-6">
                  {!myAffiliation && (
                    <div data-mbaas-oid="xv21gyb" className="flex items-start gap-2 rounded-control border border-amber-400/40 bg-amber-50 px-4 py-3">
                      <Info className="mt-0.5 h-3.5 w-3.5 shrink-0 text-amber-600" aria-hidden="true" />
                      <p data-mbaas-oid="1ow1eos" className="text-xs font-medium text-amber-700">
                  ...
                  {isLoading ? (
                    <p data-mbaas-oid="4yl3mx5" className="mt-4 text-sm text-slate-500">구성원 현황을 불러오는 중입니다...</p>
                  ) : error ? (
                    <div data-mbaas-oid="fjtp1c8" role="alert" className="mt-4 rounded-control border border-rose-300 bg-rose-50 px-4 py-3">
                      <p data-mbaas-oid="vqtk9ma" className="text-xs font-medium text-rose-700">{error}</p>
                      <Button
                        data-mbaas-oid="r1o1v6l" type="button" variant="outline" tone="neutral" size="sm"
                        className="mt-3 border-slate-300 text-slate-700 hover:bg-slate-50"
            ...
            {!isLoading && !error && (
              <>
                <section data-mbaas-oid="6knzpxv" className="bg-white py-[clamp(64px,8vw,120px)]">
                  <div data-mbaas-oid="32nk874" className="mx-auto max-w-7xl px-6">
                    <Reveal>
                      ...
                      <p data-mbaas-oid="98igx32" className="mt-2 text-sm text-slate-500">
                        역할, 상태별로 필터링해 소속 인력의 자격 현황을 확인할 수 있습니다.
                      </p>
                    </Reveal>

                    <div data-mbaas-oid="09w4thj" className="mt-8 rounded-card border border-slate-200 bg-navy p-6">
                      <Reveal>
                        <PersonnelFilterBar
                          role={role}
                          status={status}
        ...
        {activeTab === 'instructorApproval' && (
          <section data-mbaas-oid="ee1cmtd" className="bg-white py-[clamp(64px,8vw,120px)]">
            <div data-mbaas-oid="5lfshoa" className="mx-auto max-w-7xl px-6">
              <Reveal>
                ...
                <p data-mbaas-oid="jc49iat" className="mt-2 text-sm text-slate-500">
        ...
        {activeTab === 'certificateApproval' && (
          <section data-mbaas-oid="fvq8yj5" className="bg-white py-[clamp(64px,8vw,120px)]">
            <div data-mbaas-oid="5iqjyz8" className="mx-auto max-w-7xl px-6">
              <Reveal>
                ...
                <p data-mbaas-oid="td0dyp4" className="mt-2 text-sm text-slate-500">
