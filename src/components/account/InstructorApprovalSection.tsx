  ...
  return (
    <div data-mbaas-oid="iasec01" className="mt-8 rounded-card border border-white/10 bg-white/5 p-cardpad">
      ...
      {isLoading ? (
        ...
        <div data-mbaas-oid="iasec05" role="alert" className="mt-5 rounded-control border border-rose-500/30 bg-rose-500/100/10 px-4 py-3">
        ...
        <div data-mbaas-oid="iasec08" className="mt-5 space-y-4">
          {isCheckingDecision ? (
            ...
            <div data-mbaas-oid="iasec26" role="alert" className="flex items-center gap-2 rounded-control border border-rose-500/30 bg-rose-500/100/10 px-4 py-3">
          ...
          {decision.comment && (
            <p data-mbaas-oid="iasec31" className="font-mono-data text-xs tabular-nums text-slate-400">
          ...
          <div data-mbaas-oid="iasec13" className="rounded-control border border-white/10 bg-navy px-4 py-3">
            ...
            <p data-mbaas-oid="iasec16" className="mt-2 font-mono-data text-xs tabular-nums text-slate-400">
        ...
        <form data-mbaas-oid="iasec17" onSubmit={handleSubmit} className="mt-5 flex flex-col gap-4">
          {submitError && (
            <p data-mbaas-oid="iasec18" role="alert" className="rounded-control border border-rose-500/30 bg-rose-500/100/10 px-3 py-2 text-xs font-medium text-rose-300">
              {submitError}
            </p>
          )}
          ...
          <div data-mbaas-oid="iasec20" className="flex flex-col gap-1.5">
            ...
            />
            <p data-mbaas-oid="iasec32" className="text-xs text-slate-400">
