 ...
 * "비행경력증명서로 가져오기"는 관리자 승인/반려 워크플로우와 연동되어 있어요.
 */
    ...
    <div>
      <div className="mb-2 flex items-center gap-1 text-xs font-semibold text-slate-300">
        ...
        <InfoTip label="두 방법의 차이">
          <span className="font-semibold text-slate-100">엑셀로 가져오기</span>는 바로 기록에 들어가지만 관리자 확인은 거치지 않아요(참고 기록).
          <br />
          <span className="font-semibold text-slate-100">비행경력증명서로 가져오기</span>는 증명서 사진을 올리면 AI 가 칸을 채워 주고, 확인 후 저장하면 관리자가 증명서와 시간을 대조해 승인해요. 공식 총 비행시간에 넣으려면 이쪽이에요.
        </InfoTip>
      </div>
