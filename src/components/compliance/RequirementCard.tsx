...
export function RequirementCard({ item }: { item: RequirementItem }) {
  ...
  return (
    <div data-mbaas-oid="gi6fino" className="rounded-card border border-slate-200 bg-white p-5">
      ...
      <p data-mbaas-oid="o6wcly9" className="mt-3 text-sm text-slate-600">
        {item.detail}
      </p>

      {item.progress && (
        <div data-mbaas-oid="b684afd" className="mt-3">
          <div data-mbaas-oid="0uz5ef7" className="h-2 w-full overflow-hidden rounded-full bg-slate-100">
            <div
          ...
          <p data-mbaas-oid="ydy93wo" className="mt-1 font-mono-data text-xs tabular-nums text-slate-500">
