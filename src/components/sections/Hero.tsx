    ...
    >
      <defs data-mbaas-oid="jd3pung">
        <radialGradient data-mbaas-oid="buhqfhu" id="radarGlow" cx="50%" cy="50%" r="50%">
          <stop data-mbaas-oid="zia0exe" offset="0%" stopColor="#38BDF8" stopOpacity="0.35" />
          <stop data-mbaas-oid="27xd5pe" offset="100%" stopColor="#38BDF8" stopOpacity="0" />
        </radialGradient>
      </defs>
      <circle data-mbaas-oid="rs5359k" cx="240" cy="240" r="220" fill="url(#radarGlow)" />
      {[60, 110, 160, 210].map((r) => (
        <circle data-mbaas-oid="5ayitcm" key={r} cx="240" cy="240" r={r} fill="none" stroke="#38BDF8" strokeOpacity="0.25" strokeWidth="1" />
      ))}
      <line data-mbaas-oid="ycc58dk" x1="20" y1="240" x2="460" y2="240" stroke="#38BDF8" strokeOpacity="0.2" strokeWidth="1" />
      <line data-mbaas-oid="ke6o2gx" x1="240" y1="20" x2="240" y2="460" stroke="#38BDF8" strokeOpacity="0.2" strokeWidth="1" />
      <path
        ...
        strokeDasharray="6 6"
      />
      <circle data-mbaas-oid="p4y3s7f" cx="210" cy="220" r="5" fill="#38BDF8" />
      <circle data-mbaas-oid="jrgwx52" cx="300" cy="260" r="5" fill="#10B981" />
      <circle data-mbaas-oid="g4vjol9" cx="420" cy="90" r="6" fill="#38BDF8">
...
export function Hero() {
  return (
    ...
    >
      <div data-mbaas-oid="wyjpu2x" className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_20%_20%,rgba(56,189,248,0.12),transparent_55%)]" />
      ...
      <div data-mbaas-oid="n5mur3s" className="relative mx-auto grid max-w-7xl grid-cols-1 items-center gap-16 px-6 lg:grid-cols-[1.05fr_0.95fr]">
        <div data-mbaas-oid="89u7vw5">
          ...
          >
            ...
            자격 공백을 사전에 차단해 개인의 생계와 기관의 과징금 리스크를 동시에 방어합니다.
          </p>
