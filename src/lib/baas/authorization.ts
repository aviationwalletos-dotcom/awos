...
// 승인·서명 권한 검증 (SEC-001)
// ============================================================================
// [배경] 예전에는 [APPROVED]/[REJECTED]/[SIGNED] 댓글의 "내용 접두어"만 보고 판정했다.
// 댓글은 로그인 회원 누구나 달 수 있어서(bc_insert_own_author — schema24 이후에도 그대로),
// 학생이 자기 게시글에 "[SIGNED] ..." 댓글을 달아 셀프 서명하는 위조가 가능했다.
// [현재] 승인·서명 판정 자체는 `approval_requests` 테이블(schema12)로 옮겼다. 이 파일은
// 그 판정에 쓰이는 "권한 집합"(기관 계정 uuid, 승인 교관 uuid)만 제공한다.
//
