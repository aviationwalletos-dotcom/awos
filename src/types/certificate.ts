...
export const CERTIFICATE_CATEGORIES_BY_TRACK: Record<PilotTrack, CertificateCategory[]> = {
  aircraft: ['조종사 자격증명', '조종연습허가서', '한정', '계기비행증명', '조종교육증명', '항공신체검사', '항공영어구술능력증명', '무선통신사', '교관 확인', '법정교육', '기타 자격'],
  lsa: ['경량항공기 조종사 자격증명', '조종연습허가서', '경량항공기 조종교육증명', '항공신체검사', '운전면허', '무선통신사', '법정교육', '기타 자격'],
